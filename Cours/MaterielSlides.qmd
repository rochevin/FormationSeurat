...
FAIRE UN SCHEMA EVOLUTIF DU CONTENU DE SO
...
# Dans vignette 
  ...
  # on garde les 13714 genes dans pbmc@assays$RNA$scale.data

pbmc<-ScaleData(pbmc,)
Layers(pbmc[["RNA"]])
dim(pbmc@assays$RNA$scale.data) # on a plus que 2000 genes d'où des soucis (warnings) dans la suite mais c'est plus rapide pour la formation ????
